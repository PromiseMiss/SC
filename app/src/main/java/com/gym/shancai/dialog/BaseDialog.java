    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < events.size(); i++) {
            if (i != 0) {
                ...
                params.setMargins(0, MathUtils.dip2px(3), 0, MathUtils.dip2px(3));
...
//            tvContent.setBackground(ContextCompat.getDrawable(context,R.drawable.background_button_white));
