...
import com.gym.shancai.customview.addressselector.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	/** Left and rightClick padding value */
	...
	private void drawCenterRect(Canvas canvas) {
		...
		Rect rect = new Rect(left, top, rightClick, bottom)
