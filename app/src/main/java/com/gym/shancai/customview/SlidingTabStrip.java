...
public class SlidingTabStrip extends HorizontalScrollView {
    ...
    public void setMarginBotton(int marginBotton) {
    ...
    private int tabBackgroundResId = R.drawable.background_button_white_rt;
...
//                notifyDataSetChanged();
                ...
                if (tabChangeListener != null) {
                    tabChangeListener.onTabChange(position);
                }
//                pager.setCurrentItem(position);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // if there is an offset, start interpolating left and rightClick coordinates
        ...
        //画底线
        canvas.drawRect(lineLeft + marginLeftAndRight, height - indicatorHeight - marginBotton, lineRight - marginLeftAndRight, height - marginBotton,
                rectPaint);
        // draw underline
