...
import com.gym.shancai.glidetransformations.FastBlur;
import com.gym.shancai.glidetransformations.RoundedCornersAndBlurTransformation.CornerType;
...
public class RoundedCornersAndBlurTransformation implements Transformation<Bitmap> {
    ...
    private float imageViewDiameter;
    ...
    public RoundedCornersAndBlurTransformation(BitmapPool pool, int radius, int margin, CornerType cornerType) {
        ...
        imageViewDiameter = bitmapRadius * 2;
