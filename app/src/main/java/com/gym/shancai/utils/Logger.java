 ...
 */
public class Logger {
    private static Boolean MYLOG_SWITCH= !APP.EXTERNAL_RELEASE; // 日志文件总开关
    private static Boolean MYLOG_WRITE_TO_FILE= APP.EXTERNAL_RELEASE;// 日志写入文件开关
    private static char MYLOG_TYPE='v';// 输入日志类型，w代表只输出告警信息等，v代表输出所有信息

    private static String MYLOG_PATH_SDCARD_DIR= APP.getInstance().getExternalCacheDir().getAbsolutePath();// 日志文件在sdcard中的路径
